...
const I18N = {
    ...
    dict: {
        ...
        'sidebar.peaches': { en: 'Peaches', zh: 'Peaches' },
        ...
        'home.projects.desc': { en: 'Watercolors, painted miniatures, and a digital painting series starring Niuniu.', zh: '水彩画、上色的战锤模型，以及以 Niuniu 为主角的数字绘画系列。' },
        ...
        'home.about.desc': { en: 'Spencer, Yunyi, and the three cats who supervise it all: Pookah, Niuniu, and Peaches.', zh: 'Spencer、Yunyi，以及监督一切的三位猫主子：Pookah、Niuniu 和 Peaches。' },
        ...
        'peaches.p6.title': { en: 'Peaches, Selling Peaches', zh: '《Peaches 卖桃图》' },
